...
public interface WeChatPayService {
     ...
     * @throws IOException
     */
//    Map<String, Object> createOrder(String orderId, BigDecimal price, String body, String ipAddress) throws IOException;
    String createOrder(String orderId, BigDecimal price, String body, String ipAddress) throws IOException;
