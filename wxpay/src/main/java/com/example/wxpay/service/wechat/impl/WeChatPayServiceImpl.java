package com.example.wxpay.service.wechat.impl;

import com.example.wxpay.service.wechat.OrderService;
import com.example.wxpay.service.wechat.TradeService;
...
public class WeChatPayServiceImpl implements WeChatPayService {
    ...
    @Override
    public String createOrder(String orderId, BigDecimal price, String body, String ipAddress) throws IOException {
        ...
        // parameters.put("trade_type", "JSAPI"); // 公众号支付类型  TODO 小程序支付亦属于此范畴
        parameters.put("trade_type", "NATIVE"); // 扫码支付
        parameters.put("openid", "oCbA-1XPL-UcYN-wAUqJR6qPtDeo");
        // sign 必须在最后
        ...
        return wxUtils.executeHttpPost(placeUrl, parameters);
